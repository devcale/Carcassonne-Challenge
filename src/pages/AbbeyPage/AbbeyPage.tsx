...
import styling from './AbbeyPage.module.css';

export const AbbeyPage = () => {
    ...
    <>
      ...
      <div className={styling.instructionsContainer}>
        <div className={styling.instructionsContentContainer}>
          <h2 id="objective">Abbeys Ablaze Mode</h2>
          <p>
            The objective of Abbeys Ablaze is to score the most points by strategically
            placing tiles within the limits of a board. Be careful, as abbeys can now
            receive burning abbeys from the draw pile.
          </p>
          <p>
            The game is played by placing tiles on the board to create a landscape. The
            landscape will be occupied by tiles representing roads, abbeys, burning abbeys
            and cities. Each of these tiles give to or take from the player a different
            amount of points.
          </p>
          ...
          <ul>
            ...
            <li>
              <p>
                Common Abbeys give you {1 * pointsMultiplier} {pointPlural} for each tile
                that surrounds it. This way, the maximum amount of points per Abbey is{' '}
                {8 * pointsMultiplier} {pointPlural}.
              </p>
            </li>
            <li>
              <p>
                Burning Abbeys take from you {1 * pointsMultiplier} {pointPlural} for each
                tile that surrounds it. This way, the maximum amount of points you can
                lose per burning Abbey is {8 * pointsMultiplier} {pointPlural}.
              </p>
            </li>
            <li>
              <p>
